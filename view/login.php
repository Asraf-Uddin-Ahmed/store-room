						...
						<?php
							...
							if( isset($_SESSION['userId']) ) {
								...
								echo "<li>
									...
									<li>
										<a href=\"login.php\" class=\"active\"><span class=\"l\"></span><span class=\"r\"></span><span class=\"t\">Login</span></a>
									</li>";
							}
                            ...
                            <div class="art-post">
                                <div class="art-post-body">
									<div class="art-post-inner art-article">
										...
										<!-- PAGE CONTENT -->
											<form action="../controller/CheckLoginForm.php" method="post">
												<table>
													<tr>
														<td>User Name</td>
														<td><input type="text" name="loginUserName" value="<?= $objMV->getValidValue("loginUserName"); ?>" /></td>
													</tr>
													
													<tr>
														<td>Password</td>
														<td><input type="password" name="loginPassword" value="<?= $objMV->getValidValue("loginPassword"); ?>" /></td>
													</tr>
												</table>
												<p><?= $objMV->getValidValue("loginError"); ?></p>
												<input class="art-button" type="submit" value="OK"/>
												<input type="checkbox" name="rememberMe"> Remember me </input>
											</form>
											
											<a href="forgot_password.phtml">forgot password?</a>
