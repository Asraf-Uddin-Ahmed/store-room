            ...
            <div class="art-sheet-body">
                ...
                <div class="art-nav">
					...
					<!-- MENU BAR -->
						...
						<li>
							<a href="confirm_logout.php" class="active"><span class="l"></span><span class="r"></span><span class="t">Logout</span></a>
						</li>
						<li>
                                ...
                                <div class="art-post-body">
									<div class="art-post-inner art-article">
										...
										<!-- PAGE CONTENT -->
											...
											<form action="../controller/LogoutCheck.php" method="post">
												<input class="art-button" type="submit" name="yes" value="Yes" />
												<input class="art-button" type="submit" name="no" value="No" />
											</form>
