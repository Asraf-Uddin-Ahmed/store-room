									...
									<div class="art-post-inner art-article">
										<div class="art-postmetadataheader">
											<h2 class="art-postheader">
												Welcome <?= $objMV->getValidValue("loginUserName"); ?>
											</h2>
										</div>
										...
										<!-- PAGE CONTENT -->
											...
											<?php
												...
												if( isset($_SESSION['searchHistory']) ) {
													$arrayResult = $_SESSION['searchHistory'];
													echo "<table border='1'>
														<tr>
														<th></th>
														<th>Name</th>
													...
													echo "</table>";
													echo "<input type=\"submit\" name=\"download\" value=\"Download\" class=\"art-button\" />";
												} else {
													echo "<i><b>This site is for storing your important data.</b></i>";
												}
											?>
											</form>
											<?php 
