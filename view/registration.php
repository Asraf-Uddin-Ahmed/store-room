...
<head>
	...
	<!-- TITLE -->
	<title>Store Room - Registration</title>
					...
					<!-- MENU BAR -->
                		...
                		<?php
							...
							if( isset($_SESSION['userId']) ) {
								...
								//registration & login
								echo "<li>
										<a href=\"registration.php\" class=\"active\"><span class=\"l\"></span><span class=\"r\"></span><span class=\"t\">Registration</span></a>
									</li>
									<li>
                                ...
                                <div class="art-post-body">
									<div class="art-post-inner art-article">
										<div class="art-postcontent">
											...
											<form action="../controller/CheckRgistrationForm.php" method="post">
												<table>	
													<tr>
														<td>First Name</td>
														<td><input type="text" name="textFirstName" value="<?= $objMV->getValidValue("textFirstName"); ?>" /></td>
														<td><?= $objMV->getValidValue("textFirstNameError"); ?></td>
													</tr>
													
													<tr>
														<td>Last Name</td>
														<td><input type="text" name="textLastName" value="<?= $objMV->getValidValue("textLastName"); ?>" /></td>
														<td><?= $objMV->getValidValue("textLastNameError"); ?></td>
													</tr>
													
													<tr>
														<td>User Name</td>
														<td><input type="text" name="textUserName" value="<?= $objMV->getValidValue("textUserName"); ?>" /></td>
														<td><?= $objMV->getValidValue("textUserNameError"); ?></td>
													</tr>
													
													<tr>
														<td>Password</td>
														<td><input type="password" name="passwordNew" value="<?= $objMV->getValidValue("passwordNew"); ?>" /></td>
														<td><?= $objMV->getValidValue("passwordNewError"); ?></td>
													</tr>
													
													<tr>
														<td>Re-type Password</td>
														<td><input type="password" name="passwordReType" value="<?= $objMV->getValidValue("passwordReType"); ?>" /></td>
														<td><?= $objMV->getValidValue("passwordReTypeError"); ?></td>
													</tr>
													
													<tr>
														<td>Email</td>
														<td><input type="text" name="textEmail" value="<?= $objMV->getValidValue("textEmail"); ?>" /></td>
														<td><?= $objMV->getValidValue("textEmailError"); ?></td>
													</tr>
												</table>
